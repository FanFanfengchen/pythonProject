...
def sensory(effect_type):
    effects = {
        ...
        SENSORY.EMOTION: "💭 [情感] 一种熟悉而陌生的感觉涌上心头...",
    }
...
def scene_farewell_charlotte():
    ...
    pm("你睁开双眼，眼瞳深处映照出黄金色的辉煌光芒。", DELAY.EXTRA_LONG)
    pm("你伫立于此，却如同端坐在黄金宫殿的恢弘王座上。", DELAY.NARRATIVE)
    pm("仅有数息的时间，黄金大权在握。", DELAY.EXTRA_LONG)
    pm("换做其他人，光是熟悉这种力量的用法都需要很久的时间，短短几秒只能仓促的挥霍。", DELAY.PAUSE)
    pm("而对于持有者的你，运用这股力量不需要任何的额外思考，几乎化作本能。", DELAY.NARRATIVE)
    pm("你仅抬起手", DELAY.LONG)
    pm("啪嗒~轻轻的打了个响指", DELAY.SNAP_EXTRA)
    pm("召唤仪式99%......中止......", DELAY.EXTRA_LONG)
    pm("水池中即将满溢而出的黑泥，悄无声息的在金黄色的辉光之中湮灭而去，洒落作遍地粉尘。", DELAY.NARRATIVE)
    pm("眼瞳金色光芒不复的青年轻松的叹了口气，完全没有自己浪费了足以压垮小国政权的恐怖核威慑的自觉。", DELAY.PAUSE)
    pm("他扬起唇角，将汉刀赛回衣袖里，拍了拍身上的灰尘，旋即双手抄着口袋，走出了这片阴凉的背光区。", DELAY.EPIC_SCENE)
    pm("来时背对阳光，离开时面朝太阳，或许是温度正好，他在午后阳光下伸了个懒腰，慵懒的打起了哈欠，像只憨态可掬的东北金渐层……而在现实世界难以察觉的灵界海洋中，正酝酿着一场浩瀚的风暴。", DELAY.EPIC_LONGER)
...
def scene_badend_toss():
    sleep(DELAY.SNAP_EXTRA)
    pm("达成成就：硬币呢？", DELAY.CHAPTER)
    pm("抛掷吧！不要忘记开始", DELAY.NARRATIVE)
...
def epilogue():
    ...
    scenes = [
        ...
        ("当一个人成为了一国的掌权者时，其身上的所有色彩都会被无限淡化，被留下的特质往往只剩下权利本身。", DELAY.NARRATIVE),
        ("特别在这个人知晓自己一举一动都会牵扯影响上亿人时，祂就更需要抹杀自己作为人的特质，留下的仅仅是为了'幕府将军'这一名号而存在的个体。", DELAY.EPIC_SCENE),
        ("幕府便是幕府将军就是将军，世代承袭的名号，早已不需要前缀，更不需要似乎血统高贵的天皇世家的认同，血统并非最重要的条件，继子也可以继承。", DELAY.EPIC_SCENE),
        ("最重要的是素质，要在战火飘摇的世道中保持小国中立谋求之道，需要的不仅是隐忍，更是能承受重压的大心脏，以及一人守国门的强大武力。", DELAY.EPIC_SCENE),
        ("因而，作为两百年来樱岛幕府唯一的上位英灵，祂早在满十岁时，就注定会坐上幕府将军的位置，以最为殊胜的身份，统领天下大权，应许臣民宏图前景，每一代的将军，最为注重的便是瀛洲的安全和平稳。", DELAY.EPIC_LONGER),
        ("这一代更是尤甚，祂的起丶极高，故而眼界也极高，寻常的对手都不能称之为对手。", DELAY.NARRATIVE),
        ("试想，你执掌一国大权，手下武将文臣躬身效忠，国力蒸蒸日上，此等情况，除了隔海相望的东西两方外，对手几乎寥寥无几，可再如何寂寞，也不能出手，只能留在这天守阁里，看着不变的日升月落潮涨潮跌。", DELAY.EPIC_LONGER),
        ...
        ("幕府将军霍然起身，天守阁上原本晴空万里，骤然间翻滚起层层乌云，乌云深处，有赤光破空而去，如怒龙般划破云层，穿过天空，分别落向七个不同方向。", DELAY.EPIC_LONGER),
        ("赤色的雷光撕裂天空，留下醒目的色彩，劈落在瀛洲其他七座不同造型的天守阁上。", DELAY.PAUSE),
        ("天守阁的顶端，承接赤色雷霆的正是一把把造型迥异的兵刃，兵刃上刻着幕府将军的代纹。", DELAY.PAUSE),
        ("回响声再度传来将军走到天守阁边缘，指尖环绕赤雷，眺望远方。", DELAY.NARRATIVE),
        ("在天守阁下方，上百人早已跪伏在地，惊惧着将军举手投足的赫然天威。", DELAY.NARRATIVE),
        ...
        ("她轻轻抚摸额前的鹿角，听着这声回响，不知为何，竟有些酸涩感涌来。", DELAY.NARRATIVE),
        ...
        ("只披上一件外衣的鲜血公匆忙奔入办公室，打开通信塔：'连线，接通首相！'", DELAY.NARRATIVE),
        ("通信屏幕中，浮现出一张诧异的脸。", DELAY.EXTRA_LONG),
        ("同盟国秘书长，尤里乌斯·炎魔正在享受着它的下午茶时光。", DELAY.CHAPTER),
        ("'夏莎部长，您不是正在公国度假？这个点还不休息？'", DELAY.EXTRA_LONG),
        ("'怎么还睡得着！'血裔的执政官脸色没有半点血色，苍白着脸色，难看至极，甚至没时间遮掩自己的胸有沟壑：'我刚刚做了一场梦，我的梦境一向很准。'", DELAY.EPIC_SCENE),
        ...
        ("炎魔顿了顿：'这的确是坏消息，不过黑色蔷薇早在三百多年前就彻底停止活动了。'", DELAY.NARRATIVE),
        ("'我还梦到了别的。'夏莎坐在椅子上，抱住膝盖：'我梦到导师了……'", DELAY.CHAPTER),
        ("炎魔推了推鼻梁上的眼镜，无奈的摇头道：'夏莎，那已经是五百多年前的事了，如果下次只是做噩梦，别给我打电话了，我怕那边冰霜巨人那边误会。'", DELAY.EPIC_SCENE),
        ...
        ("灵界海洋，深渊层，悬浮着漆黑的蔷薇花，本是一片黯然的它，此时悄然点亮了两瓣。", DELAY.NARRATIVE),
    ]
...
def epilogue_sword_dojjo():
    scenes = [
        ("剑道场馆。", DELAY.EXTRA_LONG),
        ("'哥......你刚刚去哪了？'", DELAY.RESONATE),
        ("'人有三急。'", DELAY.COIN_TOSS),
        ("'可刚刚那不是厕所的方向啊。'", DELAY.RESONATE),
        ("'我有说过我急的是这方面吗？'", DELAY.LONG),
        ("'……'", DELAY.CHAPTER),
        ("'好了，不逗你了。'你抬手一点妹妹的额头：'我要回去了。'", DELAY.EXTRA_LONG),
        ("'这就走了？'", DELAY.VERY_SLOW),
        ("'没什么好看的，反而麻烦事不少，嗯，今晚我买菜下厨，记得早点回来。", DELAY.EPIC_SCENE),
        ("'噢噢……'柳生霜月懵懂的点头，旋即喊了声：'对了哥，我……'", DELAY.CHAPTER),
        ("她突然想到刚刚感受到的奇怪记忆，望着你的背影，只觉得突然间那么的似曾相识，像是另一个人。", DELAY.NARRATIVE),
    ]
    ...
    sleep(DELAY.MICRO if condition else DELAY.EXTRA_LONG)
    p("'怎么了？'你回头问询。")
    p("'唔，路上小心。'她还是没说出口。")

    if not condition:
        sleep(DELAY.EXTRA_LONG)
...
def epilogue_leave_school():
    scenes = [
        ...
        ("云无心停下脚步，看向前方人影，却因为你转身，只隐约看见一道眼熟的背影。", DELAY.NARRATIVE),
