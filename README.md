...
```
PythonProject/
├── 📁 学习笔记/              # 基础学习与练习代码（合并自：基础学习/、教程练习/、数学算法/）
│   ├── 12循环与列表.py
│   ├── 3角古猜想实现.py
│   ├── 9两数大小比较.py
│   ├── 列表.py
...
│   ├── 好玩的2.6.py
│   └── 王权0.27.py
├── 📁 Python数据分析/        # 数据分析相关代码（保留原样）
│   ├── 第一篇 Python编程基础/
│   │   ├── 项目1 搭建运动员欢迎系统_基础知识.py
│   │   └── 项目2 搭建运动员信息收集系统_数据类型.py
│   └── 封面.py
├── README.md              # 项目说明文件
...
- `工具库/test_calculator.py` - 计算器功能测试
- `工具库/test_sentence.py` - 句子处理测试
- `工具库/test_shopping_list.py` - 购物清单测试
...
| 目录 | 描述 |
|------|------|
| **学习笔记/** | 合并自基础学习/、教程练习/、数学算法/，包含 Python 基础学习和练习代码 |
| **工具库/** | 合并自核心/、工具/、测试/，包含核心功能模块和测试代码 |
| **游戏/** | 包含游戏相关代码，如猜数字、贪吃蛇等 |
| **认证/** | 包含认证相关代码，如注册和登录功能 |
| **图形界面/** | 包含图形界面相关代码，如动画、国旗绘制等 |
| **独立项目/** | 包含独立的项目代码，如爬虫、鼠标连点器等 |
| **旅途的开始/** | 项目初始阶段的代码，保持原样不改动 |
| **Python数据分析/** | 数据分析相关代码，保持原样不改动 |
